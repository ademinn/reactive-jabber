...
Далее следуют вспомогательные функции для работы с @XMPPState@.
...
В процессе авторизации переход из одного состояния в другое определяется текущим этапом авторизации и пришедшим сообщением.
